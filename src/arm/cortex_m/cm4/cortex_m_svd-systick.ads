...
package Cortex_M_SVD.SysTick is
   ...
   subtype SYST_RVR_RELOAD_Field is UInt24;
   ...
   subtype SYST_CVR_CURRENT_Field is UInt24;
   ...
   subtype SYST_CALIB_TENMS_Field is UInt24;
