...
package Cortex_M_SVD.MPU is
   ...
   subtype MPU_TYPE_DREGION_Field is UInt8;
   subtype MPU_TYPE_IREGION_Field is UInt8;
   ...
   subtype MPU_RNR_REGION_Field is UInt8;
   ...
   subtype MPU_RBAR_REGION_Field is UInt4;
   subtype MPU_RBAR_ADDR_Field is UInt27;
   ...
   subtype MPU_RASR_SIZE_Field is UInt5;
   ...
   subtype MPU_RASR_TEX_Field is UInt3;
   ...
   subtype RBAR_A_REGION_Field is UInt4;
   subtype RBAR_A_ADDR_Field is UInt27;
   ...
   subtype RASR_A_SIZE_Field is UInt5;
   ...
   subtype RASR_A_TEX_Field is UInt3;
