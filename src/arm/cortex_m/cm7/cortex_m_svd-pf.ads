...
package Cortex_M_SVD.PF is
   ...
   subtype CTR_ERG_Field is UInt4;
   ...
   subtype CCSIDR_LineSize_Field is UInt3;
   subtype CCSIDR_Associativity_Field is UInt10;
   subtype CCSIDR_NumSets_Field is UInt15;
