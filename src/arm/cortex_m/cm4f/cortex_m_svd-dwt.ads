...
package Cortex_M_SVD.DWT is
   ...
   subtype CTRL_POSTPRESET_Field is UInt4;
   subtype CTRL_POSTINIT_Field is UInt4;
   subtype CTRL_SYNCTAP_Field is UInt2;
   subtype CTRL_Reserved_13_15_Field is UInt3;
   subtype CTRL_NUMCOMP_Field is UInt4;
   ...
   type DWT_Peripheral is record
      ...
      CYCCNT    : aliased UInt32;
      --  CPI Count Register
      CPICNT    : aliased UInt32;
      --  Exception Overhead Count Register
      EXCCNT    : aliased UInt32;
      --  Sleep Count Register
      SLEEPCNT  : aliased UInt32;
      --  LSU Count Register
      LSUCNT    : aliased UInt32;
      --  Folded-instruction Count Register
      FOLDCNT   : aliased UInt32;
      --  Program Counter Sample Register
      PCSR      : aliased UInt32;
      --  Comparator Register 0
      COMP0     : aliased UInt32;
      --  Mask Register 0
      MASK0     : aliased UInt32;
      --  Function Register 0
      FUNCTION0 : aliased UInt32;
      --  Reserved 0
      RESERVED0 : aliased UInt32;
      --  Comparator Register 1
      COMP1     : aliased UInt32;
      --  Mask Register 1
      MASK1     : aliased UInt32;
      --  Function Register 1
      FUNCTION1 : aliased UInt32;
      --  Reserved 1
      RESERVED1 : aliased UInt32;
      --  Comparator Register 2
      COMP2     : aliased UInt32;
      --  Mask Register 2
      MASK2     : aliased UInt32;
      --  Function Register 2
      FUNCTION2 : aliased UInt32;
      --  Reserved 2
      RESERVED2 : aliased UInt32;
      --  Comparator Register 3
      COMP3     : aliased UInt32;
      --  Mask Register 3
      MASK3     : aliased UInt32;
      --  Function Register 3
      FUNCTION3 : aliased UInt32;
   end record
     with Volatile;
