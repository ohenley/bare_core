...
package Cortex_M_SVD.Cache is
   ...
   subtype DCISW_Set_Field is UInt9;
   subtype DCISW_Way_Field is UInt2;
   ...
   subtype DCCSW_Set_Field is UInt9;
   subtype DCCSW_Way_Field is UInt2;
   ...
   subtype DCCISW_Set_Field is UInt9;
   subtype DCCISW_Way_Field is UInt2;
